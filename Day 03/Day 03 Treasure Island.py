...
leftorright = input("Where do you want to go? Type 'left' or 'right'. \n").lower()
...
if leftorright == "left":
    ...
    if swimorwait == "wait":
        redyellowblue = input("You arrive at the island unharmed. There is a house with 3 doors. One 'red', one 'yellow' and one 'blue'. Which colour do you choose? \n").lower()
